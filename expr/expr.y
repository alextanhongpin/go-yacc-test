...
// The parser uses the type <prefix>Lex as a lexer. It must provide the
// method Lex(*<prefix>SymType) int and Error(string).
type exprLex struct {
	line []byte
	peek rune
}
...
func (x *exprLex) Lex(yylval *exprSymType) int {
	for {
		...
		switch c {
			...
			// Recognize Unicode multiplication and division symbols, returning
